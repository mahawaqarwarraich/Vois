...
function BlogUI(props) {
    ...
    return (
        <React.Fragment>
            ...
            <BlogBody numOfLikes={props.numOfLikes} numOfComments={props.numOfComments} isLiked={props.isLiked} {...props.config.blogStats} viewBlog={props.viewBlog} config={{...props.config.body}}/>
